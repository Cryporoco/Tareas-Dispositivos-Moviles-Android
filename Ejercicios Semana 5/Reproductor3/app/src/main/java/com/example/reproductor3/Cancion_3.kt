...
class Cancion_3 : Fragment(R.layout.fragment_cancion_3) {
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        var  cancion = MediaPlayer.create(requireContext(),R.raw.open_your_heart)
        ...
        detener.setOnClickListener{
            cancion.stop()
            cancion= MediaPlayer.create(requireContext(),R.raw.open_your_heart)
        }
    }
}